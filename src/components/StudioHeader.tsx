...
export const StudioHeader = ({ 
  ...
  return (
    <header className="flex items-center justify-between bg-transparent py-2 md:py-4 px-3 md:px-6 border-b border-purple-600/20 backdrop-blur-md shadow-[0_0_30px_rgba(179,0,255,0.25)]">
      {/* Logo - Always visible */}
